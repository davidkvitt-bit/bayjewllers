      ...
      <div className="border-b border-primary-foreground/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-xl mx-auto text-center">
            <h3 className="text-2xl md:text-3xl font-light mb-4">Join the Bay Family</h3>
            <p className="text-primary-foreground/70 mb-6">Subscribe for exclusive previews, offers, and inspiration</p>
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3">
                ...
                />
                <Button type="submit" className="bg-white text-primary hover:bg-white/90 tracking-wider text-sm px-8">
                  Subscribe
                </Button>
              </form>
            )}
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 md:gap-12">
          <div className="col-span-2">
            ...
            <p className="text-primary-foreground/70 text-sm mb-6 max-w-xs leading-relaxed">
              Family-owned British jewellers crafting exquisite rings since 1983. Hallmarked in London.
            </p>
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-3 text-primary-foreground/70">
                <Phone className="h-4 w-4 text-primary-foreground/40 flex-shrink-0" />
                <a href="tel:+442088029596" className="hover:text-primary-foreground transition-colors">020 8802 9596</a>
              </div>
              <div className="flex items-center gap-3 text-primary-foreground/70">
                <Mail className="h-4 w-4 text-primary-foreground/40 flex-shrink-0" />
                <a href="mailto:hello@bayjewellers.co.uk" className="hover:text-primary-foreground transition-colors">hello@bayjewellers.co.uk</a>
              </div>
              <div className="flex items-start gap-3 text-primary-foreground/70">
                <MapPin className="h-4 w-4 text-primary-foreground/40 flex-shrink-0 mt-0.5" />
                <span>123 High Street<br />London N16 8QY</span>
              </div>
              <div className="flex items-center gap-3 text-primary-foreground/70">
                <Clock className="h-4 w-4 text-primary-foreground/40 flex-shrink-0" />
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs text-primary-foreground/40">© 2026 Bay Jewellers Ltd. All rights reserved.</p>
            <div className="flex items-center gap-6">
              <Link href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/40 hover:text-primary-foreground transition-colors">
                <Instagram className="h-5 w-5" />
              </Link>
              <Link href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/40 hover:text-primary-foreground transition-colors">
